...
function init() {
    ...
    map = new google.maps.Map(document.getElementById('map-holder'), {
        center: {lat: 39.624262, lng: 19.921678},
        zoom: 17,
    ...
    map.data.loadGeoJson("data/2016071_review.geojson");
...
function add_rating_popup(data) {
    ...
    info_window = new google.maps.InfoWindow({
        content: '<h3>Average Rating: '+get_avg(data.feature.getProperty("ratings")).toFixed(1)+'</h3><h3>Add new rating</h3><select id="new_rating"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select>' +
